...
ROM_NAME="Corvus"
ROM="du"
LINK_MANIFEST="https://github.com/Corvus-ROM"
BRANCH_MANIFEST="10"
USER_SF="goodmeow"
...
git clone https://github.com/goodmeow/device_xiaomi_beryllium -b ten-corvus device/xiaomi/beryllium
git clone https://github.com/goodmeow/device_xiaomi_sdm845-common -b corvus-ten device/xiaomi/sdm845-common
git clone https://github.com/goodmeow/vendor_xiaomi -b ten-1 vendor/xiaomi
git clone https://github.com/GZR-Kernels/Optimus_Drunk_Beryllium -b 10.0 kernel/xiaomi/beryllium
